This is my text to speech converter, you can select pdf, docx or txt files (or create and save your own thorugh the app), it uses Amazon's polly Speech Synthesizer API to convert
